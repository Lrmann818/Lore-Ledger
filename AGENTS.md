...
15. [ ] **Current authorized work (owner authorization, 2026-07-14):** matrix **#9 — attack "Recalculate from Build" affordance** (explicit action only, stable source identity, user-owned fields preserved, preview before mutation). This authorization does **not** include other P2 items, multiclassing changes, equipment-system expansion, or greenlist changes.
16. [ ] **Still blocked / out of scope:** down-leveling (ratified out of scope), builtin content expansion beyond the SRD 5.1 greenlist, and any work outside the character-builder system
