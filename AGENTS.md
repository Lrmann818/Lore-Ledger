...
| **Character architecture** (multi-character, freeform vs. builder) | "Character Architecture" below → `docs/features/multi-character-design.md` (Part 1 only) | Part 2 of that doc (historical Step 1/2/3 notes, incl. its wrong "SRD 5.1 green list") |
...
- `docs/features/multi-character-design.md` Part 2 — historical Step 1/2/3 implementation notes; its "SRD 5.1 green list" section is **wrong** and has been struck through
