...
- 📸 **Session snapshot** — [`reference/session-handoff-2026-07-14.md`](./reference/session-handoff-2026-07-14.md) — handoff for the 2026-07-13/14 custom-content authoring run (matrix #15 complete, campaign-vault content-persistence fix); exact commits, verification results, and the recommended next step.
