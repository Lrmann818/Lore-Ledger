...
- [ ] Required builder-card edit, reorder, and customization support for builder-created characters, with an explicit ownership model for cards that mix live-derived mechanics with user-owned text/content
