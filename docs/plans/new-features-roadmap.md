...
- [x] Abilities & Features Phase 3F: manual/freeform and custom feature cards foundation
...
- [ ] Abilities & Features polish beyond the first manual/custom-card pathway, feature-use tracking, partial regain behavior, broader rest/resource automation, and specialized resource-linked cards
