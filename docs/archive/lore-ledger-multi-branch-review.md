...
1. Contract/fixture test suite (`saveCompatibility.test.js`).
2. Wizard Playwright smoke.
3. Merge builder-wizard → develop.
4. On-device wizard touch pass.
5. Delete `config 2.xml` / duplicate splash PNGs before any archive attempt.
