# Multi-Character System — Implementation Notes (Steps 1-4)

> ## 📜 ARCHIVED — HISTORICAL RECORD ONLY
>
> **Archived 2026-07-09.** This is the step-by-step record of how the multi-character
> system was built in April 2026. All four steps shipped.
>
> Its "Status" lines, "Files affected" lists, and especially its **schema version numbers**
> are frozen at the time each section was written (Step 3 below references schema v6; the
> current version is v11). Do not treat any of it as a description of today's code, and do
> not change code to match it.
>
> Its "SRD 5.1 green list" section was **wrong** and is struck through in place — it named
> Goliath, Orc, Criminal, Sage, and Soldier, none of which are SRD 5.1 content.
>
> **Canonical replacements:**
>
> - Current character-architecture rules → [`docs/features/multi-character-design.md`](../features/multi-character-design.md)
> - Shipped builtin SRD scope → [`docs/reference/builder-scope-greenlist.md`](../reference/builder-scope-greenlist.md)
> - Persisted schema → [`docs/state-schema.md`](../state-schema.md)
> - Rest behavior → [`docs/reference/rest-rules-spec.md`](../reference/rest-rules-spec.md)
>
> Kept for provenance: it records the decisions and tradeoffs later changes must respect.
...
**Status:** Complete, audited, and fully verified. See [`./character-portability.md`](../features/character-portability.md) for the full implementation rationale. (This previously also pointed at `STEP4_TASKS.md`, which no longer exists in the repo.)
