...
- Runtime builder panels continue to leave derived values unmaterialized; Builder Summary remains display-only, Builder Abilities remains temporary editing scaffolding for base scores, and canonical sheet fields stay freeform unless a normal panel explicitly owns their source.
